                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14 pb-10 md:pb-12 border-b border-primary-brown/10">
                    <div className="col-span-1 sm:col-span-2 lg:col-span-1 space-y-6">
                        ...
                        <div className="flex gap-3">
                            {/* Instagram */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white border border-primary-brown/10 flex items-center justify-center text-primary-brown hover:bg-accent-coral hover:text-white hover:border-accent-coral transition-all shadow-sm group" aria-label="Instagram">
                            ...
                            {/* X (Formerly Twitter) */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white border border-primary-brown/10 flex items-center justify-center text-primary-brown hover:bg-accent-coral hover:text-white hover:border-accent-coral transition-all shadow-sm group" aria-label="Twitter">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path>
                                </svg>
                            </a>
                            {/* Pinterest */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white border border-primary-brown/10 flex items-center justify-center text-primary-brown hover:bg-accent-coral hover:text-white hover:border-accent-coral transition-all shadow-sm group" aria-label="Pinterest">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
